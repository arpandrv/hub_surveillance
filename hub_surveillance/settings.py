"""
Django settings for hub_surveillance project.
...
ALLOWED_HOSTS = ['2029-122-150-234-236.ngrok-free.app', '127.0.0.1:8000']

# Trust the ngrok domain for CSRF checks during development
CSRF_TRUSTED_ORIGINS = ['https://2029-122-150-234-236.ngrok-free.app']
...
ROOT_URLCONF = 'hub_surveillance.urls'
...
WSGI_APPLICATION = 'hub_surveillance.wsgi.application'
